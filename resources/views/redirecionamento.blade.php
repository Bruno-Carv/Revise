...
<body>
    ...
    <!--Card com o botão de redirecionamento-->
            ...
            <div class="row size">
                ...
                <div class="col-11 col-sm-11 col-md-11 col-lg-8 col-xl-8" >
                    <div class="card bg-dark">
                        <div class="card-body " >
                            <h5 class="card-title text-light">Qual tipo de cadastro que você deseja fazer?</h5>
                            <div class="row btn_espaco">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <button type="button" class="btn btn-outline-warning size text-white " onclick="fisico()"><b>Físico</b></button>
                                </div>
                            </div>
                            <div class="row btn_espaco">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <button type="button" class="btn btn-outline-warning size text-white" onclick="juridico()"><b>Jurídico</b></button>
    ...
    <!-- Rodapé -->
    <footer class=" backgroundBlack navbar-light bg-light ">
        <div class="container-fluid">
