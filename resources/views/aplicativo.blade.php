                ...
                <div class="accordion" id="accordionExample">
                    <div class="card card_hover">
                        <div class="card-header" id="headingOne">
                            <h2 class="mb-0">
                                <button class="btn btn-link text-dark " type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" id="android">
                    ...
                    <div class="card card_hover">
                        <div class="card-header" id="headingTwo">
                            <h2 class="mb-0">
                                <button class="btn btn-link collapsed text-dark" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" id="IOS">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class=" col-12 SuporteTexto tituloBranco">
                ...
                <p>
                    Qualquer dúvida, entre em contato conosco pelas redes sociais, e-mail <a href="mailto:contatoRevise@revise.com">contatoRevise@revise.com</a> ou pelo telefone:<a href="tel:13997934483">+55 (13) 99199-4978.</a>
                </p>
            </div>
        </div>
            ...
            <div class="formularioSuport row tituloBranco">
                ...
                <div class="col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2">
                    <div class="input-group suporteBotao">
                        <button type="button" class="btn btn-outline-warning porcentagem" type="submit">Enviar</button>
                    </div>
                </div>
            </div>
        </form>
